...
# WARNING: LEGACY
# WARNING:
# WARNING: THIS INSTALLATION SCRIPT IS ONLY PROVIDED
# WARNING: TO NOT BREAK EXISTING AUTOMATIONS.
# WARNING:
# WARNING: NEW INSTALLATIONS SHOULD USE THE UPDATED
# WARNING: INSTALLATION METHODS DESCRIBED AT:
# WARNING: https://docs.datastax.com/en/astra-cli/
# WARNING:
##########################################################
...
echo "         \/     \/                   \/ "
echo " "
echo "                        Version: v$ASTRA_CLI_VERSION (Legacy)"
echo " "
echo "┌──────────────────────────────────────────────────────────┐"
echo "│                                                          │"
echo "│   ⚠️  The new and improved CLI (v1.0) is now available!   │"
echo "│                                                          │"
