...
function _complete_astra_group_config() {
  ...
  COMMANDS="use get create describe list delete"
  ...
  case ${CURR_CMD} in
    ...
    use)
      ...
      ;;
    describe)
      COMPREPLY=( $(_complete_astra_group_config_command_describe "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
  esac
...
function _complete_astra_group_config_command_describe() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db() {
  ...
  COMMANDS="list-regions delete-keyspace list-clouds download-scb delete-region list-regions-vector describe-collection create-region delete create-keyspace list-embedding-providers list-cdc create-collection list-regions-classic load delete-collection get unload create truncate-collection delete-cdc create-cdc describe-embedding-provider resume list-keyspaces list-collections list-tables list-regions-serverless count create-dotenv list get-endpoint-playground describe-table describe cqlsh get-endpoint-api truncate-table get-endpoint-swagger delete-table status"
  if [[ ${COMP_CWORD} -eq 2 ]]; then
  ...
  case ${CURR_CMD} in
    ...
    get)
      ...
      ;;
    describe)
      COMPREPLY=( $(_complete_astra_group_db_command_describe "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    status)
    ...
    list-keyspaces)
      ...
      ;;
    list-collections)
      COMPREPLY=( $(_complete_astra_group_db_command_listcollections "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    delete-collection)
      COMPREPLY=( $(_complete_astra_group_db_command_deletecollection "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    create-collection)
      COMPREPLY=( $(_complete_astra_group_db_command_createcollection "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    describe-collection)
      ...
      ;;
    truncate-collection)
      COMPREPLY=( $(_complete_astra_group_db_command_truncatecollection "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    list-tables)
      ...
      ;;
    delete-table)
      COMPREPLY=( $(_complete_astra_group_db_command_deletetable "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    delete-table)
      ...
      ;;
    truncate-table)
      COMPREPLY=( $(_complete_astra_group_db_command_truncatetable "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    describe-table)
      COMPREPLY=( $(_complete_astra_group_db_command_describetable "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    ...
    list-regions-serverless)
      ...
      ;;
    list-regions-vector)
      COMPREPLY=( $(_complete_astra_group_db_command_listregionsvector "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    list-clouds)
      COMPREPLY=( $(_complete_astra_group_db_command_listclouds "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    count)
    ...
    get-endpoint-swagger)
      COMPREPLY=( $(_complete_astra_group_db_command_getendpointswagger "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    get-endpoint-playground)
      COMPREPLY=( $(_complete_astra_group_db_command_getendpointplayground "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    get-endpoint-api)
      COMPREPLY=( $(_complete_astra_group_db_command_getendpointapi "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    list-cdc)
      COMPREPLY=( $(_complete_astra_group_db_command_listcdc "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    delete-cdc)
      COMPREPLY=( $(_complete_astra_group_db_command_deletecdc "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    create-cdc)
      COMPREPLY=( $(_complete_astra_group_db_command_createcdc "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
  esac
...
function _complete_astra_group_db_command_create() {
  ...
  FLAG_OPTS="--no-color --async --vector --if-not-exist -v --verbose --if-not-exists"
  ARG_OPTS="--token --keyspace --region --config-file -o -r --timeout --config -cf -c --tier -conf --cloud --capacity-units --env -k --output"
...
function _complete_astra_group_db_command_delete() {
  ...
  ARG_OPTS="--token -cf --config-file -o -conf --timeout --env --config --output"
...
function _complete_astra_group_db_command_list() {
  ...
  FLAG_OPTS="--no-color --vector -v --verbose"
  ARG_OPTS="--token -cf --config-file -o -conf --env --config --output"
...
function _complete_astra_group_db_command_get() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file -o -conf --env --config -k --key --output"
...
function _complete_astra_group_db_command_describe() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_downloadscb() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file --region -o -r -f -conf --env --config --output-file --output"
...
function _complete_astra_group_db_command_createdotenv() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token --config-file --keyspace --region -o -r --config -cf --directory -d -conf --env -k --output"
...
function _complete_astra_group_db_command_createkeyspace() {
  ...
  ARG_OPTS="--token -cf --config-file --keyspace -o -conf --timeout --env -k --config --output"
...
function _complete_astra_group_db_command_listcollections() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_deletecollection() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_createcollection() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_truncatecollection() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file --keyspace -o -c -conf --collection --env -k --config --output"
...
function _complete_astra_group_db_command_deletetable() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
  ...
  FLAG_OPTS="--no-color --async --if-exists -v --verbose"
  ARG_OPTS="--token --config-file --keyspace -o -t --timeout --config -cf -conf --table --env -k --output"
...
function _complete_astra_group_db_command_truncatetable() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file --keyspace -o -t -conf --table --env -k --config --output"
...
function _complete_astra_group_db_command_describetable() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_createregion() {
  ...
  FLAG_OPTS="--no-color --async --if-not-exist -v --verbose --wait"
  ARG_OPTS="--token --region --config-file -o -r -t --timeout --config -cf -c --tier -conf --cloud --env --output"
...
function _complete_astra_group_db_command_deleteregion() {
  ...
  FLAG_OPTS="--no-color --async -v --verbose --wait"
  ARG_OPTS="--token -cf --config-file --region -o -r -conf --timeout --env --config --output"
...
function _complete_astra_group_db_command_listregionsclassic() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file -o -c -conf -f --cloud --env --config --filter --output"
...
function _complete_astra_group_db_command_listregionsvector() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_listclouds() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_count() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token --keyspace --config-file -query -o -encoding -t --config -cf --dsbulk-config --schema.query -maxConcurrentQueries -conf -logDir --table --env -k --output"
...
function _complete_astra_group_db_command_load() {
  ...
  ARG_OPTS="--token --keyspace --config-file -query -encoding -skipRecords --schema.allowMissingFields -cf --dsbulk-config -header -delim -maxConcurrentQueries -logDir --schema.mapping --env -k -m -o -maxErrors -t --config -url --schema.query -conf --table --output"
...
function _complete_astra_group_db_command_unload() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token --keyspace --config-file -query -encoding -skipRecords -cf --dsbulk-config -header -delim -maxConcurrentQueries -logDir --schema.mapping --env -k -m -o -maxErrors -t --config -url --schema.query -conf --table --output"
...
function _complete_astra_group_db_command_cqlsh() {
  ...
  ARG_OPTS="--token --execute --keyspace --config-file -o --file --config --connect-timeout -cf -e --request-timeout -f -conf --encoding --env -k --output"
...
function _complete_astra_group_db_command_getendpointswagger() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file --region -o -r -conf --env --config --output"
...
function _complete_astra_group_db_command_getendpointplayground() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_getendpointapi() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_listcdc() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_deletecdc() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token --config-file --keyspace -o -id --tenant --config -cf -conf --table --env -k --output"
...
function _complete_astra_group_db_command_createcdc() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
  ...
  FLAG_OPTS="--no-color --async -v --verbose"
  ARG_OPTS="--token --keyspace --config-file -o --tenant --timeout --config -cf -conf -p, --partition --table --env -k --output"
...
function _complete_astra_group_streaming() {
  ...
  COMMANDS="list-regions list-clouds create-dotenv list delete exist list-cdc get create pulsar-token describe status pulsar-shell"
  if [[ ${COMP_CWORD} -eq 2 ]]; then
  ...
  case ${CURR_CMD} in
    ...
    get)
      ...
      ;;
    describe)
      COMPREPLY=( $(_complete_astra_group_streaming_command_describe "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    exist)
    ...
    list-regions)
      ...
      ;;
    list-clouds)
      COMPREPLY=( $(_complete_astra_group_streaming_command_listclouds "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    pulsar-shell)
...
function _complete_astra_group_streaming_command_create() {
  ...
  ARG_OPTS="--token --region --config-file -o -p -r --cluster --config -cf --plan -c -cl -e --email -conf --cloud --env --output"
...
function _complete_astra_group_streaming_command_describe() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_streaming_command_createdotenv() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file --directory -o -d -conf --env --config --output"
...
function _complete_astra_group_streaming_command_listclouds() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_streaming_command_pulsarshell() {
  ...
  ARG_OPTS="--token -cf --execute-command --config-file -o --filename -e -f -conf --env --config --output"
...
function _complete_astra_group_role() {
  ...
  case ${CURR_CMD} in
    ...
    get)
      ...
      ;;
    describe)
      COMPREPLY=( $(_complete_astra_group_role_command_describe "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
  esac
...
function _complete_astra_group_role_command_describe() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_user() {
  ...
  COMMANDS="get invite describe list delete"
  if [[ ${COMP_CWORD} -eq 2 ]]; then
  ...
  case ${CURR_CMD} in
    ...
    list)
      ...
      ;;
    describe)
      COMPREPLY=( $(_complete_astra_group_user_command_describe "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
  esac
...
function _complete_astra_group_user_command_invite() {
  ...
  FLAG_OPTS="--no-color -v --verbose"
  ARG_OPTS="--token -cf --config-file -o -r -conf --env --config --role --output"
...
function _complete_astra_group_user_command_describe() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_command_login() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra() {
  ...
  COMMANDS="help streaming role org setup login config user db ? token"
  ...
  case ${CURR_CMD} in 
    ...
    setup)
      ...
      ;;
    login)
      COMPREPLY=( $(_complete_astra_command_login "${COMMANDS}" ) )
      return $?
      ;;
    help)
