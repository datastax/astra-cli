...
function _complete_astra_group_config() {
  ...
  COMMANDS="get create list delete"
...
function _complete_astra_group_org() {
  ...
  COMMANDS="list-regions-classic list-regions-serverless get name id"
  if [[ ${COMP_CWORD} -eq 2 ]]; then
  ...
  case ${CURR_CMD} in
    ...
    list-regions-classic)
      COMPREPLY=( $(_complete_astra_group_org_command_listregionsclassic "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    list-regions-serverless)
      COMPREPLY=( $(_complete_astra_group_org_command_listregionsserverless "${COMMANDS}" ) )
      echo ${COMPREPLY[@]}
      return $?
      ;;
    get)
...
function _complete_astra_group_org_command_listregionsclassic() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_org_command_listregionsserverless() {
  # Get completion data
  COMPREPLY=()
  CURR_WORD=${COMP_WORDS[COMP_CWORD]}
  PREV_WORD=${COMP_WORDS[COMP_CWORD-1]}
...
function _complete_astra_group_db_command_create() {
  ...
  FLAG_OPTS="--no-color --if-not-exist -v --verbose --if-not-exists --wait"
...
function _complete_astra_group_db_command_delete() {
  ...
  FLAG_OPTS="--no-color -v --verbose --wait"
...
function _complete_astra_group_db_command_createkeyspace() {
  ...
  FLAG_OPTS="--no-color --if-not-exist -v --verbose"
  ARG_OPTS="--token -cf --config-file --keyspace -o -conf -k --config --output"
...
function _complete_astra_group_streaming() {
  ...
  COMMANDS="exist get create pulsar-token create-dotenv list delete status pulsar-shell"
  if [[ ${COMP_CWORD} -eq 2 ]]; then
...
function _complete_astra() {
  ...
  COMMANDS="help streaming role org setup config user db ?"
