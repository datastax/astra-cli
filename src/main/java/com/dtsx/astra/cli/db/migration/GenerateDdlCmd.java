...
/**
 * Will generate the DDL for a keyspace
 */
@Command(name = "generate-ddl", description = "Generate CQL files for a keyspace")
public class GenerateDdlCmd extends AbstractDatabaseCmd {
