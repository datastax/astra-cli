...
import com.dtsx.astra.cli.commands.db.dataapi.DataAPICmd;
...
import com.dtsx.astra.cli.commands.db.misc.RerankingProvidersListCmd;
import com.dtsx.astra.cli.commands.db.region.RegionCreateCmd;
import com.dtsx.astra.cli.commands.db.region.RegionDeleteCmd;
...
@Command(
    ...
    subcommands = {
        ...
        RerankingProvidersListCmd.class,
        CdcListCmd.class,
        CdcCreateCmd.class,
        CdcDeleteCmd.class,
